        ...
        var CognexVideo = function(){
            ...
            this.init_player = function(){
                ...
                autoplay: false,
                playlist: [{
                            0: {src: "http://jamesemmettdesign.com/cognex_video/projektor/media/test1.ogv", type: "video/ogg", title: 'dsadsa'},
                            1: {src: "http://jamesemmettdesign.com/cognex_video/projektor/media/intro_.mp4", type: "video/mp4", title: 'test1'},
                            2: {src: "http://jamesemmettdesign.com/cognex_video/projektor/media/intro.webm", type: "video/webm", title: 'test1'}
                            },
                            {
